        ...
        <tr>
        	<td>
                ...
                <form name="createServiceRequest" method="POST" onSubmit="return checkForm(this);" action="CreateServiceRequest">
                    ...
                    Requestor:<br>
                    <input type="text" name="requestor" value="<jsp:getProperty name="shared" property="empFirstName"/>&nbsp;<jsp:getProperty name="shared" property="empLastName"/>"><br>
                    Client ID:<br>
                    <input type="text" name="clientId" value="<jsp:getProperty name="shared" property="empCompany"/>"><br>
                    Equipment ID:<br>
                    <input type="text" name="equipId" value=""><br>
                    Problem:<br>
                    <textarea rows="4" cols="50" name="problemDescription" maxlength="2000" value=""></textarea>
