        ...
        <tr>
        	<td>
                ...
                <form name="createServiceRequest" method="POST" onSubmit="return checkForm(this);" action="CreateServiceRequest">
                    ...
                    Requestor:<br>
                    <input type="text" name="requestor" value=""><br>
                    <input type="hidden" name="clientId" value="<jsp:getProperty name="shared" property="clientId"/>"> 
                    Equipment ID:<br>
                    <input type="text" name="equipId" value=""><br>
                    Problem:<br>
                    <textarea rows="4" cols="50" name="problemDescription" maxlength="2000"></textarea>
